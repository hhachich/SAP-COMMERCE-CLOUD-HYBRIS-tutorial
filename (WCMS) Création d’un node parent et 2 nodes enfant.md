...
### Création du node enfant 2

Création de  `CMSNavigationNode` 

```xml
INSERT_UPDATE CMSNavigationNode	;uid[unique=true] ;$contentCV[unique=true];name ;parent(uid, $contentCV) ;&nodeRef ;Children(uid,$contentCV); links(&linkRef);
;ChildCategoryNodeTest	;;Child Category Node Test;ParentCategoryNode ;ChildCategoryNodeTest ;ChildCategorie-1Test, ChildCategorie-2Test
```
...
```xml
INSERT_UPDATE CMSNavigationNode	;uid[unique=true]	;$contentCV[unique=true];name ;&nodeRef ; links(&linkRef)
;ChildCategorie-1Test ;;Child Categorie 1 Test ;ChildCategorie-1Test
;ChildCategorie-2Test ;;Child Categorie 2 Test ;ChildCategorie-2Test
```
...
```xml
INSERT_UPDATE CMSNavigationEntry;uid[unique=true] ;$contentCV[unique=true];name ;navigationNode(&nodeRef) ;item(CMSLinkComponent.uid,CMSLinkComponent.$contentCV);
;ChildCategorie-1-EntryTest ;;Child Category 1 Entry Test ;ChildCategorie-1Test;ChildCategorie-1-LinkTest
;ChildCategorie-2-EntryTest ;;Child Category 2 Entry Test;ChildCategorie-1Test;ChildCategorie-2-LinkTest
```
...
```xml
INSERT_UPDATE CMSLinkComponent ;$contentCV[unique=true];uid[unique=true] ;name ;url ;category(code, $productCV)	;target(code)[default='sameWindow'];;
;;ChildCategorie-1-LinkTest	;Child Category 1 Link ComponentTest	;/test	;;;;
;;ChildCategorie-2-LinkTest	;Child Category 2 Link ComponentTest	;/test	;;;;
```
...
```xml
UPDATE CMSNavigationNode ;$contentCV[unique=true];uid[unique=true] ;title[lang=en]
;;ChildCategorie-1Test ;"Child 1"
;;ChildCategorie-2Test ;"Child 2"
;;ChildCategoryNodeTest ;" Categorie 2"

UPDATE CMSLinkComponent	;$contentCV[unique=true];uid[unique=true] ;linkName[lang=en]
;;ChildCategorie-1-LinkTest	;"Child 1"
;;ChildCategorie-2-LinkTest	;"Child 2"
```
